...
if __name__ == '__main__':
    ...
    *****************************************
    CUDA_VISIBLE_DEVICES=7 screen python Vimeo90K_m.py --testset_path /mnt/disks/ssd0/dataset/vimeo_septuplet/ --ckpt ../experiments/IFRNet_septuplet_wofloloss_300epoch_bs24_lr1e-4/ckpts/latest.pth --config ../experiments/IFRNet_septuplet_wofloloss_300epoch_bs24_lr1e-4/IFRNet_septuplet_wofloloss.yaml
    """
    parser = argparse.ArgumentParser()
    parser.add_argument('-c', '--config',
                        default='../experiments/AMT-S_septuplet_wofloloss_400epoch_bs24_lr2e-4/AMT-S_septuplet_wofloloss.yaml')
    parser.add_argument('-p', '--ckpt',
                        default='../experiments/AMT-S_septuplet_wofloloss_400epoch_bs24_lr2e-4/ckpts/latest.pth', )
    ...
    for i in f:
        ...
        for timestep, gt_index in zip(timesteps, gt_indices):
            if args.mid_only:
                if gt_index != 3:
                    continue
            mid = model(I0, I2, embt=timestep, eval=True)['imgt_pred']
            I1 = Is[gt_index]
