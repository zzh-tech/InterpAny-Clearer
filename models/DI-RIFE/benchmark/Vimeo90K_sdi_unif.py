...
if __name__ == '__main__':
    """
    cmd:
    CUDA_VISIBLE_DEVICES=5 python Vimeo90K_sdi_unif.py --model_dir ../experiments/rife_sdi_m_noavg_blur_triplet/train_sdi_log --testset_path /mnt/disks/ssd0/dataset/vimeo_triplet/ --blur --clip
    """
