...
from networks.blocks.ifrnet_recur import (
    resize,
    Encoder,
    InitDecoder,
    IntermediateDecoder
)
from networks.blocks.multi_flow_recur import (
    multi_flow_combine,
    MultiFlowDecoder
)
...
class Model(nn.Module):
    ...
    def forward(self, img0, img1, img_ref, embt, embt_ref, scale_factor=1.0, eval=False, **kwargs):
        ...
        up_flow0_4, up_flow1_4, ft_3_ = self.decoder4(f0_4, f1_4, f_ref_4, embt_4, embt_ref_4, use_sdi=True)
        ...
        ######################################### the 3rd decoder #########################################
        up_flow0_3, up_flow1_3, ft_2_ = self.decoder3(ft_3_, f0_3, f1_3, f_ref_3, up_flow0_4, up_flow1_4)
        ...
        ######################################### the 2nd decoder #########################################
        up_flow0_2, up_flow1_2, ft_1_ = self.decoder2(ft_2_, f0_2, f1_2, f_ref_2, up_flow0_3, up_flow1_3)
        ...
        ######################################### the 1st decoder #########################################
        up_flow0_1, up_flow1_1, mask, img_res = self.decoder1(ft_1_, f0_1, f1_1, f_ref_1, up_flow0_2, up_flow1_2)
